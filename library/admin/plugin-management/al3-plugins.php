<?php
/*
 * al3 PLUGIN ACTIVATION
 *
 * This piece of code is basically a list of plugins,
 * which we can either recommend or force to use with
 * the theme. By not shipping the plugins directly, we
 * avoid having old versions of plugins inside our theme.
 * Neat.
 *
*/
