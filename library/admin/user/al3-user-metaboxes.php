        ...
        if ( function_exists('acf_add_local_field_group') ) {
            ...
            acf_add_local_field_group( array (
                ...
                array (
                    ...
                    array (
			'key' => 'field_598efce6f7c1e',
			'label' => 'user_badges',
			'name' => 'user_badges',
			'type' => 'checkbox',
			'instructions' => 'Badges the user has earned',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
			...
			'save_custom' => 0,
			'default_value' => array (
				0 => 'wn: Wolf Neckerchief',
				1 => 'wv: Wolf Badge',
				2 => 'sn: Scout Neckerchief',
				3 => 'sv: Scout Badge / Rover Badge',
				4 => 'rn: Rover Neckerchief',
			),
			'layout' => 'vertical',
			'toggle' => 1,
			'return_format' => 'label',
                ...
                array (
                    'key' => 'field_598dd531790c0',
                    'label' => __('Youth Leader Card No.', 'al3'),
                    'name' => 'user_juleica_no',
                    'type' => 'number',
                    'instructions' => __('What number shows the youth leader card of this user?', 'al3'),
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array (
                        'width' => '',
                ...
                array (
                    'key' => 'field_598dd58a790c1',
                    'label' => __('Youth Leader Card Expiration Date', 'al3'),
                    'name' => 'user_juleica_date',
                    'type' => 'date_picker',
                    'instructions' => __('When does the Youth Leader Card expire?', 'al3'),
                    'required' => 0,
                    'conditional_logic' => 0,
                    'wrapper' => array (
                        'width' => '',
