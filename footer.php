            ...
            <?php if ( !(is_search() || is_404() )) { ?>
                ...
                <div id="expanding-search" class="expanding-search">
                    <form method="get" action="<?php echo home_url( '/' ); ?>">
                        <input class="expanding-search-input" placeholder="<?php _e( 'Search …', 'al3' ) ?>" type="search" value="<?php echo get_search_query() ?>" name="s" id="search" title="<?php _e( 'Search for:', 'al3' ) ?>">
