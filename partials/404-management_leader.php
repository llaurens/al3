...
<article id="post-not-found" class="not-found hentry cf">
    ...
    <header class="article-header">
        <h1><?php _e( 'Oops, no Captain found!', 'al3' ); ?></h1>
    </header>

    <div class="entry-content">
        <p><?php _e( 'Wow, this is strange: We either have no head of management or this is website is broken. Most likely the last option.', 'al3' ); ?></p>
    </div>
